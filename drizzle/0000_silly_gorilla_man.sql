...
CREATE INDEX `idx_admin_session_admin_id` ON `sys_admin_session` (`admin_id`);--> statement-breakpoint
CREATE INDEX `idx_admin_session_expires_at` ON `sys_admin_session` (`expires_at`);--> statement-breakpoint
CREATE INDEX `idx_admin_session_revoked_at` ON `sys_admin_session` (`revoked_at`);--> statement-breakpoint
...
CREATE INDEX `idx_group` ON `sys_config` (`config_group`);